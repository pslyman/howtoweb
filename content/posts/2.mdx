...
4. Download [this index.html file](https://cloud.devlay.com/s/5e4LDNbTqABWCoB) and put it in that folder (firstApp). Then open that folder in VSCode (File -> Open Folder). 
